...
export const basicCandlestickChartData = {
    series: [
        {
            data: [
    ...
    options: {
        ...
        plotOptions: {
            candlestick: {
                colors: {
                    upward: hexToRGB(getLocalStorageItem("color-primary", "#0F626A"), 1),
                    downward: hexToRGB(getLocalStorageItem("color-secondary", "#817D8D"), 1),
                },
            },
        },
        xaxis: {
