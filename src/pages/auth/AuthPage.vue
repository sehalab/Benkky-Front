      ...
      <div class="forms-panel" :class="isDarkTheme ? 'dark-forms' : 'light-forms'">
        ...
        <div class="forms-container">
          ...
          <div class="forms-footer" :class="isDarkTheme ? 'dark-footer' : 'light-footer'">
            ...
            <div class="back-home">
              <router-link to="/" class="back-link" :class="isDarkTheme ? 'dark-back-link' : 'light-back-link'">
...
const clearFlashMessage = (type = null) => {
  if (type) {
    if (flashMessage.value[type]) {
      delete flashMessage.value[type];
    }
  } else {
    flashMessage.value = {};
  }
...
const submitLogin = async () => {
  ...
  try {
    ...
    if (error.errors) {
      ...
      validationErrors.value = { _general: [error.message] };
    }
  }
};
